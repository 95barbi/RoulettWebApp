...
public class Populator {
	...
	@PostConstruct
	public void init() {
		firstnames = Arrays.asList("Bálint", "Kata", "Jani", "Feri", "Viktor", "Balázs", "Attila", "Gábor", "András", "Marci",
				"Ági", "Sári", "Eszter", "Réka");
		lastnames = Arrays.asList("Kovács", "Kocsis", "Szabó", "Borbély", "Nagy", "Honti", "Gyopár", "Tószegi", "Arató");
